...
int main(int, char const*[])
{
    ...
    Window::Parameters parameters(L"MinimumAreaBox2DWindow", 0, 0, 512, 512);
    auto window = TheWindowSystem.Create<MinimumAreaBox2DWindow>(parameters);
    ...
    Window2(parameters)
{
    ...
    std::ifstream input("projection.raw", std::ios::binary);
