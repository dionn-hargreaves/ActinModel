...
int main(int, char const*[])
{
    ...
    Window::Parameters parameters(L"ShortestPathWindow", 0, 0,
        ShortestPathWindow::ISIZE, ShortestPathWindow::ISIZE);

    auto window = TheWindowSystem.Create<ShortestPathWindow>(parameters);
