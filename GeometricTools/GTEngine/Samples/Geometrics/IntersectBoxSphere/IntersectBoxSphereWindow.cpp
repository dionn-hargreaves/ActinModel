...
#include "IntersectBoxSphereWindow.h"
...
int main(int, char const*[])
{
    ...
    Window::Parameters parameters(L"IntersectBoxSphereWindow", 0, 0, 512, 512);
    auto window = TheWindowSystem.Create<IntersectBoxSphereWindow>(parameters);
    TheWindowSystem.MessagePump(window, TheWindowSystem.DEFAULT_ACTION);
    TheWindowSystem.Destroy<IntersectBoxSphereWindow>(window);
    return 0;
}

IntersectBoxSphereWindow::IntersectBoxSphereWindow(Parameters& parameters)
    :
    Window3(parameters)
{
...
void IntersectBoxSphereWindow::OnIdle()
{
    mTimer.Measure();
...
bool IntersectBoxSphereWindow::OnCharPress(unsigned char key, int x, int y)
{
...
void IntersectBoxSphereWindow::CreateScene()
{
...
void IntersectBoxSphereWindow::Translate(int direction, float delta)
{
...
void IntersectBoxSphereWindow::Rotate(int direction, float delta)
{
...
void IntersectBoxSphereWindow::TestIntersection()
{
