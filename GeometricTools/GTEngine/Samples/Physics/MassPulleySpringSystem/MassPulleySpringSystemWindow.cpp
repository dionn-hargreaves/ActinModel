...
int main(int, char const*[])
{
    ...
    Window::Parameters parameters(L"MassPulleySpringSystemWindow", 0, 0, 640, 480);
    auto window = TheWindowSystem.Create<MassPulleySpringSystemWindow>(parameters);
    TheWindowSystem.MessagePump(window, TheWindowSystem.DEFAULT_ACTION);
    TheWindowSystem.Destroy<MassPulleySpringSystemWindow>(window);
    return 0;
}

MassPulleySpringSystemWindow::MassPulleySpringSystemWindow(Parameters& parameters)
    :
    Window3(parameters),
...
void MassPulleySpringSystemWindow::OnIdle()
{
    mTimer.Measure();
...
bool MassPulleySpringSystemWindow::OnCharPress(unsigned char key, int x, int y)
{
    switch (key)
    {
    case 'w':
...
bool MassPulleySpringSystemWindow::SetEnvironment()
{
...
void MassPulleySpringSystemWindow::InitializeModule()
{
...
void MassPulleySpringSystemWindow::CreateScene()
{
...
void MassPulleySpringSystemWindow::CreateFloor()
{
...
void MassPulleySpringSystemWindow::CreateCable()
{
...
std::shared_ptr<Visual> MassPulleySpringSystemWindow::CreateMass(float radius)
{
    VertexFormat vformat;
    vformat.Bind(VA_POSITION, DF_R32G32B32_FLOAT, 0);
    MeshFactory mf;
...
void MassPulleySpringSystemWindow::CreatePulley()
{
    VertexFormat vformat;
    vformat.Bind(VA_POSITION, DF_R32G32B32_FLOAT, 0);
    vformat.Bind(VA_TEXCOORD, DF_R32G32_FLOAT, 0);
...
void MassPulleySpringSystemWindow::CreateSpring()
{
    float const thickness = 4.0f;
    float xExtent = 2.0f;
    float yExtent = 18.0f;
...
void MassPulleySpringSystemWindow::CreateHelix()
{
    MeshDescription desc(MeshTopology::CYLINDER, 128, 16);
...
void MassPulleySpringSystemWindow::UpdatePulley()
{
...
void MassPulleySpringSystemWindow::UpdateCable()
{
...
void MassPulleySpringSystemWindow::UpdateHelix()
{
...
void MassPulleySpringSystemWindow::PhysicsTick()
{
    mModule.Update();
...
void MassPulleySpringSystemWindow::GraphicsTick()
{
