...
inline float PhysicsModule::GetY1() const
{
    return mState[0];
}

inline float PhysicsModule::GetY1Dot() const
{
    return mState[1];
}

inline float PhysicsModule::GetY2() const
{
    return mState[2];
}

inline float PhysicsModule::GetY2Dot() const
{
    return mState[3];
}
