...
int main(int, char const*[])
{
    ...
    Window::Parameters parameters(L"GelatinCubeWindow", 0, 0, 512, 512);
    auto window = TheWindowSystem.Create<GelatinCubeWindow>(parameters);
    TheWindowSystem.MessagePump(window, TheWindowSystem.DEFAULT_ACTION);
    TheWindowSystem.Destroy<GelatinCubeWindow>(window);
    return 0;
}

GelatinCubeWindow::GelatinCubeWindow(Parameters& parameters)
    :
    Window3(parameters)
{
    if (!SetEnvironment())
...
bool GelatinCubeWindow::OnCharPress(unsigned char key, int x, int y)
{
    switch (key)
    {
    case 'w':
...
bool GelatinCubeWindow::SetEnvironment()
{
...
void GelatinCubeWindow::CreateScene()
{
...
void GelatinCubeWindow::CreateCube()
{
...
void GelatinCubeWindow::CreateSprings()
{
...
void GelatinCubeWindow::PhysicsTick()
{
...
void GelatinCubeWindow::GraphicsTick()
{
...
void GelatinCubeWindow::CreateFaceVertices(unsigned int numRows, unsigned int numCols,
...
void GelatinCubeWindow::CreateFaceIndices(unsigned int numRows, unsigned int numCols,
...
void GelatinCubeWindow::UpdateFaces()
{
