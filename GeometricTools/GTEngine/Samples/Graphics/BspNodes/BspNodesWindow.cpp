...
int main(int, char const*[])
{
    ...
    Window::Parameters parameters(L"BspNodesWindow", 0, 0, 640, 480);
    auto window = TheWindowSystem.Create<BspNodesWindow>(parameters);
    TheWindowSystem.MessagePump(window, TheWindowSystem.DEFAULT_ACTION);
    TheWindowSystem.Destroy<BspNodesWindow>(window);
    return 0;
}
