...
class GTE_IMPEXP GL4Engine : public GraphicsEngine
{
...
protected:
    ...
    // GTEngine GL4 requires OpenGL 4.3 or later for compute shaders.
    int mMajor, mMinor;
...
inline bool GL4Engine::MeetsRequirements() const
{
