...
class GTE_IMPEXP PointLightTextureEffect : public LightingEffect
{
public:
    // Construction.
    PointLightTextureEffect(std::shared_ptr<ProgramFactory> const& factory,
...
inline std::shared_ptr<Texture2> const& PointLightTextureEffect::GetTexture() const
{
    return mTexture;
}

inline std::shared_ptr<SamplerState> const& PointLightTextureEffect::GetSampler() const
{
    return mSampler;
}
