...
CameraRig::CameraRig(std::shared_ptr<Camera> const& camera, float translationSpeed, float rotationSpeed)
{
    Set(camera, translationSpeed, rotationSpeed);
}

void CameraRig::Set(std::shared_ptr<Camera> const& camera, float translationSpeed, float rotationSpeed)
{
    mCamera = camera;
